...
/*# sourceURL=ace/css/ace_scrollbar.css */</style>
  ...
  <link rel="stylesheet" href="./dataprocessing_files/fonts.css">
  ...
  <script async="" src="./dataprocessing_files/clarity.js.download"></script><script async="" src="./dataprocessing_files/kl8gh6lk26"></script><script type="text/javascript" async="" src="./dataprocessing_files/analytics.js.download"></script><script type="text/javascript" async="" src="./dataprocessing_files/js"></script><script async="" src="./dataprocessing_files/gtm.js.download"></script><script>
  ...
  <script src="./dataprocessing_files/stub.min.js.download"></script>
  <script async="" src="./dataprocessing_files/cmp.js.download"></script>
  ...
  <link href="./dataprocessing_files/css2" rel="stylesheet">
  <link rel="stylesheet" href="./dataprocessing_files/styles.94017793f7f1bebc8d88.css">
  <!-- Global site tag (gtag.js) - Google Analytics -->

<link rel="preconnect" href="https://cmp.uniconsent.com/"><script src="./dataprocessing_files/main-v5.min.js.download" async=""></script><script src="./dataprocessing_files/mode-python.js.download"></script><script src="./dataprocessing_files/theme-twilight.js.download"></script></head>
        ...
        <div class="nav-header-wrapper">
          <div class="nav-logo-title-wrapper">
            <a href="https://www.programiz.com/" target="_blank" class="nav-logo-link">
              <img id="nav-logo" src="./dataprocessing_files/logo-inverted.svg">
            </a>
          </div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M29.9196 33.8549C32.0265 33.0205 36.1973 31.7405 38.4533 35.8806C38.9712 36.8532 40.1207 31.7059 35.9618 26.8506L35.8873 26.7661C35.9081 26.6956 35.9286 26.6286 35.9487 26.5631C35.9889 26.4317 36.0272 26.3061 36.0638 26.1702C38.159 18.6894 33.1565 9.75527 24.7445 5C28.3777 9.66308 30.0412 15.2949 28.5857 20.25C28.4536 20.7083 28.2951 21.1588 28.1109 21.5995C27.9383 21.4841 27.7225 21.361 27.4439 21.2149C21.1601 17.3644 15.3113 12.871 9.99608 7.81009C13.1936 12.2165 16.7354 16.3731 20.5896 20.2423C17.8902 18.7855 10.3022 13.638 5.53115 9.5593C6.1325 10.4985 6.82774 11.3767 7.60662 12.181C11.5537 16.9401 16.8504 22.768 23.0888 27.2504C18.7062 29.7914 12.4836 29.9798 6.257 27.2504C4.73944 26.619 3.30917 25.8028 2 24.8209C4.81703 28.9559 8.83711 32.1663 13.539 34.0355C19.5694 36.4535 25.5607 36.2113 29.9196 33.8549Z" fill="#25265E" fill-opacity="0.67"></path>
    ...
    <div class="notification " id="notification" style="display:none;">
      <div class="check-icon-wrapper">
        <img src="./dataprocessing_files/check.svg" alt="check">
      </div>
          ...
          <div class="logo-wrapper">
            <h1 class="logo-title-wrapper">
              <a href="https://www.programiz.com/" target="_blank" class="logo-link">
                <img id="logo" src="./dataprocessing_files/logo-inverted.svg">
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="other-options-wrapper">
          ...
          <div class="mobile-top-bar-run-button run"><img src="./dataprocessing_files/play.svg" alt="run-icon"></div>
        </div>
      </div>
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div id="editor" class=" ace_editor ace-twilight ace_dark" style="font-family: &quot;Droid Sans Mono&quot;; font-size: 14px; line-height: 22px; height: 479px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" aria-haspopup="false" aria-autocomplete="both" role="textbox" aria-label="Cursor at row 38" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 478px; left: 205px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 50px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: -511px; left: 0px; width: 50px;"><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 506px;">18<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, row 18"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 528px;">19<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 550px;">20<span class="ace_fold-widget ace_start ace_open" tabindex="-1" aria-expanded="true" title="Fold code" style="height: 22px; display: inline-block;" role="button" aria-label="Toggle code folding, rows 20 through 21"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 572px;">21<span class="ace_fold-widget ace_start ace_open" tabindex="0" aria-expanded="true" title="Fold code" style="height: 22px; display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 594px;">22<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 616px;">23<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 638px;">24<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 24 through 29"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 44px; top: 660px;">25<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 704px;">26<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 726px;">27<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 748px;">28<span class="ace_fold-widget ace_start ace_open" tabindex="0" aria-expanded="true" title="Fold code" style="height: 22px; display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 770px;">29<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 792px;">30<span class="ace_fold-widget ace_start ace_open" tabindex="0" aria-expanded="true" title="Fold code" style="height: 22px; display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 814px;">31<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 836px;">32<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 858px;">33<span class="ace_fold-widget ace_start ace_open" tabindex="0" aria-expanded="true" title="Fold code" style="height: 22px; display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 880px;">34<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 34 through 38"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 902px;">35<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 924px;">36<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 946px;">37<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 37 through 38"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell ace_gutter-active-line " aria-hidden="true" style="height: 22px; top: 968px;">38<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div></div></div><div class="ace_scroller " style="line-height: 22px; left: 49.8047px; right: 15px; bottom: 0px;"><div class="ace_content" style="top: -5px; left: 0px; width: 589.195px; height: 523px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 676px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 22px; top: 462px; left: 0px; right: 0px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 22px; width: 8.40234px; top: 462px; left: 146.84px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 22px; width: 8.40234px; top: 462px; left: 113.23px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: -506px; left: 0px;"><div class="ace_line_group" style="height: 22px; top: 506px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">stu</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Chemistry"</span><span class="ace_paren ace_rparen">]</span> <span class="ace_keyword ace_operator">&gt;=</span> <span class="ace_constant ace_numeric">35</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 528px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">stu</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Result"</span><span class="ace_paren ace_rparen">]</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">"Pass"</span></div></div><div class="ace_line_group" style="height: 22px; top: 550px;"><div class="ace_line" style="height: 22px;">    <span class="ace_keyword">else</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 572px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">stu</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">"Result"</span><span class="ace_paren ace_rparen">]</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">"Fail"</span></div></div><div class="ace_line_group" style="height: 22px; top: 594px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 616px;"><div class="ace_line" style="height: 22px;"><span class="ace_comment"># Write to CSV file</span></div></div><div class="ace_line_group" style="height: 22px; top: 638px;"><div class="ace_line" style="height: 22px;"><span class="ace_keyword">with</span> <span class="ace_support ace_function">open</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"students.csv"</span><span class="ace_punctuation">,</span> <span class="ace_string">"w"</span><span class="ace_punctuation">,</span> <span class="ace_identifier">newline</span><span class="ace_keyword ace_operator">=</span><span class="ace_string">""</span><span class="ace_paren ace_rparen">)</span> <span class="ace_keyword">as</span> <span class="ace_identifier">f</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 44px; top: 660px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">fieldnames</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_paren ace_lparen">[</span><span class="ace_string">"Name"</span><span class="ace_punctuation">,</span> <span class="ace_string">"Tamil"</span><span class="ace_punctuation">,</span> <span class="ace_string">"English"</span><span class="ace_punctuation">,</span> <span class="ace_string">"Maths"</span><span class="ace_punctuation">,</span> <span class="ace_string">"Physics"</span><span class="ace_punctuation">,</span> </div><div class="ace_line" style="height: 22px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="ace_string">"Chemistry"</span><span class="ace_punctuation">,</span> <span class="ace_string">"Average"</span><span class="ace_punctuation">,</span> <span class="ace_string">"Result"</span><span class="ace_paren ace_rparen">]</span></div></div><div class="ace_line_group" style="height: 22px; top: 704px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">writer</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">csv</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">DictWriter</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">f</span><span class="ace_punctuation">,</span> <span class="ace_identifier">fieldnames</span><span class="ace_keyword ace_operator">=</span><span class="ace_identifier">fieldnames</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 726px;"><div class="ace_line" style="height: 22px;">    </div></div><div class="ace_line_group" style="height: 22px; top: 748px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">writer</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">writeheader</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 770px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">writer</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">writerows</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">students</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 792px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 814px;"><div class="ace_line" style="height: 22px;"><span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"Student data saved"</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 836px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 858px;"><div class="ace_line" style="height: 22px;"><span class="ace_comment"># Read from CSV file</span></div></div><div class="ace_line_group" style="height: 22px; top: 880px;"><div class="ace_line" style="height: 22px;"><span class="ace_keyword">with</span> <span class="ace_support ace_function">open</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"students.csv"</span><span class="ace_punctuation">,</span> <span class="ace_string">"r"</span><span class="ace_paren ace_rparen">)</span> <span class="ace_keyword">as</span> <span class="ace_identifier">f</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 902px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">reader</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">csv</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">DictReader</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">f</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 924px;"><div class="ace_line" style="height: 22px;">    </div></div><div class="ace_line_group" style="height: 22px; top: 946px;"><div class="ace_line" style="height: 22px;">    <span class="ace_keyword">for</span> <span class="ace_identifier">row</span> <span class="ace_keyword">in</span> <span class="ace_identifier">reader</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 968px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">row</span><span class="ace_paren ace_rparen">)</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 462px; left: 155px; width: 8px; height: 22px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; height: 479px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 990px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 49.8047px; right: 15px; width: 589.195px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 604px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; font-language-override: inherit; overflow: visible;"></div></div><div class="ace_tooltip" role="tooltip" style="display: none; pointer-events: auto;"></div></div>
      </div>
  ...
  <!-- The use of the cloudflare cdn for all external libraries is intential. We are trying to reduce the number
         of DNS lookups.
    -->
  <script defer="" src="./dataprocessing_files/socket.io.min.js.download"></script>
  <iframe name="__tcfapiLocator" style="display: none;" src="./dataprocessing_files/saved_resource.html"></iframe><iframe name="__uspapiLocator" style="display: none;" src="./dataprocessing_files/saved_resource(1).html"></iframe><iframe name="__gppLocator" style="display: none;" src="./dataprocessing_files/saved_resource(2).html"></iframe><script defer="" src="./dataprocessing_files/jquery.min.js.download"></script>

  <script defer="" src="./dataprocessing_files/ace.js.download"></script>
  <script defer="" src="./dataprocessing_files/mousetrap.min.js.download"></script>
  <script defer="" src="./dataprocessing_files/final.bb49e05630288743055e.js.download"></script>

  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TKXT7MH" height="0" width="0"
      style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->
<script defer="" src="./dataprocessing_files/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon="{&quot;version&quot;:&quot;2024.11.0&quot;,&quot;token&quot;:&quot;0a465ad039704d1f9760ad556f6f3cdd&quot;,&quot;r&quot;:1,&quot;server_timing&quot;:{&quot;name&quot;:{&quot;cfCacheStatus&quot;:true,&quot;cfEdge&quot;:true,&quot;cfExtPri&quot;:true,&quot;cfL4&quot;:true,&quot;cfOrigin&quot;:true,&quot;cfSpeedBrain&quot;:true},&quot;location_startswith&quot;:null}}" crossorigin="anonymous"></script>
